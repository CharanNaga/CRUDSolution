...
namespace CRUDExample.Controllers
{
    ...
    [TypeFilter(typeof(ResponseHeaderActionFilter), Arguments = new object[] { "CustomKey-FromController", "CustomValue-FromController" },Order = 2)] //passing arguments to filter constructor helpful in response headers.
    public class PersonsController : Controller
    {
        ...
        [TypeFilter(typeof(ResponseHeaderActionFilter),Arguments = new object[] {"CustomKey-FromAction","CustomValue-FromAction"},Order = 1)] //passing arguments to filter constructor helpful in response headers.
